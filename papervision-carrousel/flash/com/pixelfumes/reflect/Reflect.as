package com.pixelfumes.reflect{
	...
	public class Reflect extends MovieClip{
		...
		function Reflect(args:Object){
			...
			var originalPosX = mc.getChildAt(0).x;
			...
			for(var a = 0; a < mc.numChildren; a++){
				mc.getChildAt(a).x = 0;
			}
			
			mcBMP.draw(mc);
			//mc.getChildAt(0).x = originalValue;
			...
			for(var i = 0; i < mc.numChildren; i++){
				mc.getChildAt(i).x = originalPosX;
			}
		...
		private function update(mc):void {
			...
			mc.getChildAt(0).x = originalPosX;
		}
